...
namespace SCCheckinV3.Controllers
{
    public class MerchandiseController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ItemID,ItemName,ItemDesc,ItemPrice")] Merchandise merchandise)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ItemID,ItemName,ItemDesc,ItemPrice")] Merchandise merchandise)
        {
            if (ModelState.IsValid)
            {
